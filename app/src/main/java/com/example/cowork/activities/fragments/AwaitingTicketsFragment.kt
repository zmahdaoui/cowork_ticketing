...
class AwaitingTicketsFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_awaiting_tickets,  container, false)!!


        recyclerView = view.findViewById(R.id.awaiting_tickets)
    ...
    private fun loadData(id: Int) {
        myCompositeDisposable.add(
            RetrofitClient.instance.getProAwaitingTicket(id)
    ...
    private fun loadData2(id: Int) {
        myCompositeDisposable.add(
            RetrofitClient.instance.getClientAwaitingTicket(id)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
