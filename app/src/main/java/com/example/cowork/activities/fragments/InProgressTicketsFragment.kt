...
class InProgressTicketsFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_in_progress_tickets,  container, false)!!

        recyclerView = view.findViewById(R.id.in_progress_tickets)
    ...
    private fun loadData(id: Int) {
        myCompositeDisposable.add(
            RetrofitClient.instance.getProInProgressTicket(id)
    ...
    private fun loadData2(id: Int) {
        myCompositeDisposable.add(
            RetrofitClient.instance.getClientInProgressTicket(id)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
